...
const styles = StyleSheet.create({
  screen: { paddingTop: spacing[3], paddingBottom: spacing[4] },
  ...
  artwork: { flex: 1, minHeight: 300, alignItems: 'center', justifyContent: 'center', marginVertical: spacing[2] },
  artCard: { position: 'absolute', width: 190, height: 250, borderRadius: 28, overflow: 'hidden', ...shadows.card },
  backCard: { transform: [{ translateX: -56 }, { rotate: '-13deg' }, { scale: 0.9 }] },
  middleCard: { transform: [{ translateX: 52 }, { rotate: '12deg' }, { scale: 0.93 }] },
  frontCard: { padding: spacing[4], alignItems: 'center', justifyContent: 'center' },
  artBadge: { position: 'absolute', top: 16, left: 16, paddingHorizontal: 10, paddingVertical: 6, borderRadius: radii.pill, backgroundColor: 'rgba(20,18,16,0.55)' },
  artProduct: { width: 66, height: 108, borderRadius: 26, backgroundColor: 'rgba(255,255,255,0.85)', alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 14, transform: [{ rotate: '8deg' }] },
  artShine: { position: 'absolute', left: 10, top: 10, width: 9, height: 60, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.55)' },
  artCaption: { position: 'absolute', left: 18, bottom: 18 },
  floatHeart: { position: 'absolute', right: 27, bottom: 35, width: 52, height: 52, borderRadius: 26, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', ...shadows.floating },
  copy: { gap: spacing[3], marginBottom: spacing[5] },
  actions: { gap: spacing[3] },
  note: { textAlign: 'center', paddingHorizontal: spacing[4] },
});
